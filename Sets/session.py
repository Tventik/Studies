...
#
# Напишите программу, которая преобразует списки во множества и
# убирает повторяющиеся элементы. Затем удаляет минимальный элемент
# из каждого множества и добавляет туда случайное число в диапазоне от 100 до 200.
...
print('Минимальный элемент 1-го множества:', min(nums_set_1))
print('Минимальный элемент 2-го множества:', min(nums_set_2))
nums_set_1.discard(min(nums_set_1))
nums_set_2.remove(min(nums_set_2))
print('Первое множество без минимального числа:', nums_set_1)
print('Второе множество без минимального числа:', nums_set_2)
nums_set_1.add(random.randint(100, 200))
nums_set_2.add(random.randint(100, 200))
print('Первое множество c добавленным случайным числом:', nums_set_1)
print('Второе множество c добавленным случайным числом:', nums_set_2)
# print(sorted(nums_set_2))
print('Объединение множеств:', nums_set_1.union(nums_set_2))
...
print('Элементы, входящие во второе множество, и не входящие в первое: ', nums_set_2 - nums_set_1)
print('Элементы, входящие во второе множество, и не входящие в первое: ', nums_set_2.difference(nums_set_1))
