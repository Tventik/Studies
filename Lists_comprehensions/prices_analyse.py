...
lost_prices = [i_price for i_price in new_prices if i_price < 0]
new_prices = [0 if i_price < 0 else i_price for i_price in new_prices]

print(original_prices)
print(new_prices)
print("Мы потеряли:", abs(sum(lost_prices)))
...
# если есть отрицательные цены, то программа их зануляет и в конце
