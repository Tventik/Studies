...
print('\nСписок кубов чисел в диапазоне от ', left_border, ' до ', right_border, ': ', cubes, sep='')
print('Список квадратов чисел в диапазоне от ', left_border, ' до ', right_border, ': ', squares, sep='')
